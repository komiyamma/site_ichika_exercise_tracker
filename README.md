...
プログラミングに初めて挑戦する方や、HTML/CSS/JavaScriptの基本を復習したい女子大生のみなさんに向けて、キャラクターたちと一緒に学べるストーリー仕立ての解説（`D00.md`～`D13.md`）を用意しています。
...
開発中は、基本となる `index.html` と `script.js` をいつでも見返せるように、エディタで開いておくと学習がスムーズに進みますよ！
