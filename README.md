...
プログラミングに初めて挑戦する方や、HTML/CSS/JavaScriptの基本を復習したい初心者向けて、キャラクターたちと一緒に学べるストーリー仕立ての解説（`D00.md`～`D14.md`）を用意しています。
...
開発中は、いつでも `index.html` と `script.js` を確認出来るようにして進めましょう。
